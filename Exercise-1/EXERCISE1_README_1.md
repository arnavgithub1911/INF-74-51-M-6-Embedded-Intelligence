...
[EI-EX-1 Dataset on Kaggle](https://www.kaggle.com/datasets/arnavhoskote/ei-ex-1/data)

Download the dataset and place the `Protocol` folder in the project root directory before running the notebook/scripts.
